...
CREATE INDEX idx_facture_assurance_facture ON facture_assurance(facture_id);
CREATE INDEX idx_facture_assurance_assurance ON facture_assurance(assurance_id);
